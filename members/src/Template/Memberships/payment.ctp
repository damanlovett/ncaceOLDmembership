...
<div class="row" style="margin-left:25px;">
	<div id="tabs">
		  <ul>
		    ...
		    <li><a href="#tabs-3">Group Memberships</a></li>
		  </ul>
...
<img alt="" border="0" src="https://www.paypalobjects.com/en_US/i/scr/pixel.gif" width="1" height="1">
		  ...
		  <div id="tabs-3">
		  	<p>Group memberships payments are handled by one individual of the organization.  If you are not the primary contact please make sure you have informed them that you have renewed your membership.</p>
		  	    	<p><strong>Members:</strong><br />There is nothing more for you to do, your membership will be paid by the main contact for the organization.  If the membership changes or you are no longer associated with the organization you may be billed for an individual membership.</p>
		  	    	<p><strong>Main Contact:</strong><br />Payment for Group memberships can be paid by Credit Card or Check.  Please click on the 'Credit Card' tab or the 'Checks' tab to make payment. As the main contact for the organization, you will be notified about changes or questions the membership chair may have about the account.</p>
		  </div>

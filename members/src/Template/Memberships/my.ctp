...
<div class="panel panel-success">
    ...
    <?= $this->Form->create($membership,['class'=>'form-horizontal']) ?>
		...
		<div class="um-form-row form-group">
			...
			<div class="col-sm-2">
            <?php echo $this->Form->input('member_year', ['div'=>false, 'label'=>false, 'class'=>'form-control', 'value'=>$current->title]);?>
            </div>
		</div>
		...
		<div class="um-form-row form-group">
			<label for="due_amount" class='col-sm-3 control-label'><?php echo __('Amount Paying Today');?></label>
...
<div class="panel panel-info">
  <div class="panel-heading"><span class="glyphicon glyphicon-info-sign" aria-hidden="true"></span><strong><?= $due->title;?></strong></div>
  <div class="panel-body small"><?= $due->body;?></div>
</div>
</div>
</div>		
			
		<div class="um-form-row form-group">
			<label for="members_included" class='col-sm-3  control-label'><?php echo __('If this is a group membership<br /><span style="color:red;font-weight:normal;"><i>List institution and members</i></span>');?></label>
			<div class="col-sm-5">	
...
<div class="panel panel-info">
  <div class="panel-heading"><span class="glyphicon glyphicon-info-sign" aria-hidden="true"></span><strong><?= $mentor->title;?></strong></div>
  <div class="panel-body small"><?= $mentor->body;?></div>
</div>
</div>
</div>	        

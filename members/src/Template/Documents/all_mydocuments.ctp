				...
				foreach($documents as $row) {
					...
					echo "<tr>";
						...
						echo "<td>";
									...
									echo "<a class='btn btn-success btn-xs' role='button' title='download' target='_blank' href='".SITE_URL."library/documents/".$row['user_id']."/".$row['doc_file']."'><span class='glyphicon glyphicon-download-alt' aria-hidden='true'></span></a>";
									echo "&nbsp;&nbsp;";
